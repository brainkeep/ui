...
export const changeNewProblemName = problem_name => dispatch => {
  dispatch(
    {type: ActionTypes.CHANGE_NEW_PROBLEM_NAME, payload: problem_name});
};
...
export const saveNewProblem = (coder_id, problem_name, problem_url) =>
  dispatch => {
    ...
    axios({
      ...
      .then(response => dispatch(
        {type: ActionTypes.SAVE_NEW_PROBLEM_FULFILLED, payload: response}))
      .catch(err => dispatch(
        {type: ActionTypes.SAVE_NEW_PROBLEM_REJECTED, payload: err}))
