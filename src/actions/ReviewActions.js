...
export const completeReview = data => dispatch => {
  ...
  axios({
    ...
    {type: ActionTypes.UPDATE_REVIEW_QUEUE_REJECTED, payload: err}));
  ...
  axios({
    ...
    {type: ActionTypes.UPDATE_IN_REVIEW_PROBLEMS_REJECTED, payload: err}));
};
...
export const fetchReviewQueue = (coder_id = -1) => dispatch => {
  ...
  axios({
    ...
    {type: ActionTypes.FETCH_REVIEW_QUEUE_REJECTED, payload: err}));
};
