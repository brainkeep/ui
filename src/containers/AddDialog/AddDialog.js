...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    changeNewQuestionName: (question_name) => dispatch(
      AddDialogActions.changeNewQuestionName(question_name)),
    changeNewQuestionUrl: (question_url) => dispatch(
      AddDialogActions.changeNewQuestionUrl(question_url)),
    saveNewQuestion: (coder_id, question_name, question_url, default_set_id) => dispatch(
      AddDialogActions.saveNewQuestion(coder_id, question_name, question_url, default_set_id)),
  }
}
