...
class Stats extends React.Component {
    ...
    render() {
        ...
        const numProblemsSolved = "You solved total of " + data.length + " problems.";
        const numReviews = data.map(d => d.times_solved).reduce((a, b) => a + b, 0) - data.length
        const numReviewCompleted = "You completed total of " + numReviews + " reviews.";
        return (
            <div>
                <IconButton 
